...
- (void)layoutSubviews{
    ...
    _imageView.frame = RR(CCWidth(29), CCHeight(33), self.width-CCWidth(29)*2, CCHeight(54));
    _titleLabel.frame = RR(0, CGRectGetMaxY(_imageView.frame) + 8, self.width , CCHeight(12));
}
